...
public class JobServiceImpl implements JobService {
    ...
    @Override
    public JobDetailDto create(CreateUpdateJobDto request) {
    ...
    @Override
    public JobDetailDto update(UUID id, CreateUpdateJobDto request) {
    ...
    @Override
    public MessageResponseDto apply(UUID id) {
        Optional<Job> job = jobRepository.findById(id);
        if (job.isEmpty())
            throw new ResourceNotFoundException("Job not found");
